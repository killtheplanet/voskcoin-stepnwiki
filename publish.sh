...
function generate_toc () {
	...
	cat toc.tmp  | grep -v 'NOTOC'  | sed s/-#heading/https:\\/\\/voskcointalk.com\\/t\\/stepn-wiki-faq\\/38192#heading/g > toc.html
}
...
# MAIN
generate_json
generate_toc part01-main.txt
generate_payload_content toc.html part01-main.txt 
generate_payload
upload_payload 98475 payload
